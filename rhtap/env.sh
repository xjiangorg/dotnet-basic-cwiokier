...
export IMAGE_URL=${IMAGE_URL-quay.io/quay_xjiang/dotnet-basic-cwiokier:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/xjiangorg/dotnet-basic-cwiokier-gitops
